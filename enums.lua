...
lib.TURRET = {
    ...
    GATLING = {
        ...
        sound = SOUNDS.library["shoot_gatling"]:clone(),
    ...
    PLASMA = {
        ...
        sound = SOUNDS.library["shoot_plasma"]:clone(),
    ...
    FREEZE = {
        ...
        sound = SOUNDS.library["shoot_freeze"]:clone(),
    ...
    TESLA = {
        ...
        sound = SOUNDS.library["shoot_tesla"]:clone(),
